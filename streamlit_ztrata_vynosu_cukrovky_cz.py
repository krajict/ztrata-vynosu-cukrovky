...
# Vstupy uživatele
sowing_input = st.text_input("Datum setí (ve formátu DDMMRRRR)", value="01042025")
damage_input = st.text_input("Datum škody (ve formátu DDMMRRRR)", value="01062025")
...
if not sowing_date or not damage_date:
    st.error("Zadejte obě data ve správném formátu DDMMRRRR.")
else:
    ...
    # Interpolace a ořezání na min. 0
